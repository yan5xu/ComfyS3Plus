        ...
        for image in images:
            ...
            try:
                ...
                with tempfile.NamedTemporaryFile(delete=False, suffix=".png") as temp_file:
                    ...
                    img.save(temp_file_path, format='PNG', pnginfo=metadata, compress_level=self.compress_level)
                    ...
                    file_path = S3_INSTANCE.upload_file(temp_file_path, s3_path, extra_args=extra_args)
